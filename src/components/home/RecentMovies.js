...
const RecentMovies = () => {
  ...
  if (!recent.length) {
    return (
      <div className="mb-8">
        ...
        <div className="rounded-2xl bg-cinema-800 border border-white/5 p-8 text-center">
  ...
  return (
    <div className="mb-8">
      ...
      <div className="rounded-2xl bg-cinema-800 border border-white/5 divide-y divide-white/5 overflow-hidden">
        {recent.map((movie) => (
          <Link
            key={movie.id}
